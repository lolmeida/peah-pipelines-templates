...
resource "aws_iam_role" "sep-github-ci" {
  name               = "sep-github-ci"
...
resource "aws_iam_role_policy" "sep-policy" {
  name   = "sep-github-ci-policy"
  role   = aws_iam_role.sep-github-ci.id
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
      {
...
resource "aws_iam_role_policy" "sep-services-policy" {
  name = "sep-services-policy"
  role = aws_iam_role.sep-github-ci.id
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
