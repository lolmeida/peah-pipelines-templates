...
resource "aws_iam_role" "trm-github-ci" {
  name               = "trm-github-ci"
...
resource "aws_iam_role_policy" "trm-policy" {
  name   = "trm-github-ci-policy"
  role   = aws_iam_role.trm-github-ci.id
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
      {
...
resource "aws_iam_role_policy" "experience-services-policy" {
  name = "experience-services-policy"
  role = aws_iam_role.trm-github-ci.id
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
