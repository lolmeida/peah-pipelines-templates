...
async function main() {
    ...
    const trim = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getBooleanInput("trim");

    let content = (0,fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync)(path, "utf8");
    if (trim) {
...
main().catch(err => _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed(err.message))
